...
class BootstrapManager(
    ...
    private fun configureRootfs() {
        ...
        listOf(
            ...
            "$rootfsDir/root/.mobicoder/data",
            "$rootfsDir/root/.mobicoder/memory",
            "$rootfsDir/root/.mobicoder/skills",
            "$rootfsDir/root/.mobicoder/config",
            "$rootfsDir/root/.mobicoder/extensions",
            "$rootfsDir/root/.mobicoder/logs",
    ...
    fun installBionicBypass() {
        val bypassDir = File("$rootfsDir/root/.mobicoder")
        if (!bypassDir.exists()) {
            bypassDir.mkdirs()
        }
...
""".trimIndent()
        ...
        //    Usage: node /root/.mobicoder/node-wrapper.js <script> [args...]
        val wrapperContent = """
...
require('/root/.mobicoder/proot-compat.js');
...
""".trimIndent()
        ...
        //    Loaded via NODE_OPTIONS="--require /root/.mobicoder/bionic-bypass.js"
        val bypassContent = """
...
""".trimIndent()
        ...
        val exportLine = "export NODE_OPTIONS=\"--require /root/.mobicoder/bionic-bypass.js\""
...
""".trimIndent())
    ...
    /** Read a file from inside the rootfs (e.g. /root/.mobicoder/mobicoder.json). */
