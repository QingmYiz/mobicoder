...
class MobiCoderApp extends StatelessWidget {
  const MobiCoderApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider<AgentProvider, NodeProvider>(
          create: (_) => NodeProvider(),
          update: (_, agentProvider, nodeProvider) {
            nodeProvider!.onGatewayStateChanged(agentProvider.state);
            return nodeProvider;
          },
        ),
      ],
