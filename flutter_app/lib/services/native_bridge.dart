...
class NativeBridge {
  ...
  static Future<bool> startAgent() async {
    return await _channel.invokeMethod('startAgent');
  }

  static Future<bool> stopAgent() async {
    return await _channel.invokeMethod('stopAgent');
  }

  static Future<bool> isAgentRunning() async {
    return await _channel.invokeMethod('isAgentRunning');
  }
  ...
  static Stream<String> get agentLogStream {
