      ...
      try {
        ...
        if (oldVersion != null && oldVersion != AppConstants.version) {
          ...
          if (hasPermission) {
            ...
            final snapshotPath = '$sdcard/Download/mobicoder-snapshot-$oldVersion.json';
            final agentConfigJson = await NativeBridge.readRootfsFile('root/.mobicoder/mobicoder.json');
            final snapshot = {
              'version': oldVersion,
