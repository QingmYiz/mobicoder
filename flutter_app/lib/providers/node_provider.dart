...
class NodeProvider extends ChangeNotifier with WidgetsBindingObserver {
  ...
  void onGatewayStateChanged(AgentState agentState) {
    final wasRunning = _lastAgentState?.isRunning ?? false;
    final isRunning = agentState.isRunning;
    _lastAgentState = agentState;
